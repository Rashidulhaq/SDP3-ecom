...
<html lang="en">
	<head>
	    ...
	    <title>Gift Shop Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/ff.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
...
<?php
$ret=mysqli_query($con,"select * from products where category=2 and subCategory=19");
while ($row=mysqli_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Men</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=1 and subCategory=13");
while ($row=mysqli_fetch_array($ret)) 
{
?>
